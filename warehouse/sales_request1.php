    ...
    return "
        ...
        <head>
            ...
            <style>
                ...
                .doc-number { font-weight: bold; font-size: 18px; }
                .details { margin: 20px 0; }
                table { width: 100%; border_id-collapse: collapse; }
                table, th, td { border_id: 1px solid #ddd; }
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<tr style='--row-index: {$no};'>
                                            <td>{$no}</td>
                                            <td class='order_id-date'>".date('d M Y H:i', strtotime($row['request_date']))."</td>
