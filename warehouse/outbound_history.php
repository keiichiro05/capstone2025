...
$sql_outbound = "SELECT o.*, w.Nama as item_name, p.Nama as pegawai_name 
                 FROM outbound_log o
                 JOIN warehouse w ON o.id_barang = w.id_barang
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">
            <section class="content-header">
                <h1>
                    Outbound History
                    <small>All records of items leaving the warehouse</small>
                </h1>
                <ol class="breadcrumb">
                                    ...
                                    <table class="history-table">
                                        ...
                                        <tbody>
                                            <?php if (empty($outbound_history)): ?>
                                                <tr>
                                                    <td colspan="8" class="text-center">No outbound records found.</td>
                                                </tr>
                                            <?php else: ?>
                                                <?php $no = 1; ?>
